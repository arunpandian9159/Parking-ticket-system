    ...
    return (
        <SpotlightCard className="p-4 sm:p-8" spotlightColor="rgba(6, 182, 212, 0.15)">
            <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-sm sm:text-lg leading-relaxed mb-3 sm:mb-6">"{quote}"</p>
        ...
        >
            ...
            <div className="relative z-10">
                ...
                <div className="mb-3 sm:mb-6">
                    ...
                    {price !== "Custom" && <span className="text-muted-foreground text-sm ml-1 sm:ml-2">/mo</span>}
                </div>
...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative rounded-lg sm:rounded-2xl border border-border bg-card backdrop-blur-xl overflow-hidden shadow-xl sm:shadow-2xl">
                            <div className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-3 border-b border-border bg-secondary/50">
                                ...
                                <span className="ml-2 sm:ml-4 text-[10px] sm:text-xs text-muted-foreground hidden sm:inline">dashboard.parksmart.io</span>
                            </div>
                            <div className="p-2 sm:p-8 grid grid-cols-3 gap-1.5 sm:gap-6">
                                ...
                                <div className="bg-linear-to-br from-cyan-500/10 to-cyan-500/5 border border-cyan-500/20 rounded-lg sm:rounded-xl p-2 sm:p-6">
                                    ...
                                    <p className="text-muted-foreground text-[8px] sm:text-sm mt-0.5 sm:mt-2">8 free</p>
                                </div>
                                <div className="bg-linear-to-br from-emerald-500/10 to-emerald-500/5 border border-emerald-500/20 rounded-lg sm:rounded-xl p-2 sm:p-6">
                                    ...
                                    <p className="text-muted-foreground text-[8px] sm:text-sm mt-0.5 sm:mt-2">Today</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="features" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
                ...
                <div className="mx-auto max-w-2xl lg:max-w-none">
                    <div className="grid grid-cols-1 gap-3 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature, index) => (
                            <FadeIn key={index} delay={index * 0.1}>
                                <SpotlightCard className="p-4 sm:p-8 h-full group" spotlightColor="rgba(6, 182, 212, 0.15)">
                                    <div className="flex flex-col h-full relative z-10">
                                        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-4">
                                            <div className={`rounded-lg sm:rounded-xl bg-linear-to-br ${feature.gradient} p-2 sm:p-3 group-hover:scale-110 transition-transform duration-300 shrink-0`}>
                                                <feature.icon className="h-4 w-4 sm:h-5 sm:w-5 text-white" aria-hidden="true" />
                                            </div>
            ...
            {/* How It Works */}
            <section id="how-it-works" className="py-6 sm:py-8 bg-linear-to-b from-background to-secondary/30">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <FadeIn className="mx-auto max-w-2xl lg:text-center mb-6 sm:mb-16">
                ...
                <FadeIn delay={0.4} className="mt-6 sm:mt-12 text-center">
                    <div className="inline-flex items-center gap-1 sm:gap-2 text-muted-foreground">
                        <div className="flex -space-x-1 sm:-space-x-2">
                            {[...Array(5)].map((_, i) => (
                                <div key={i} className="w-5 h-5 sm:w-8 sm:h-8 rounded-full bg-linear-to-br from-teal-500 to-cyan-600 border-2 border-background flex items-center justify-center text-[8px] sm:text-xs text-white font-medium">
            ...
            {/* Pricing */}
            <section id="pricing" className="py-8 sm:py-32 bg-linear-to-b from-background to-secondary/30">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <FadeIn className="mx-auto max-w-2xl lg:text-center mb-6 sm:mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-12">
                        <div className="md:col-span-1">
                            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-6">
                                ...
                                />
                                <span className="text-base sm:text-xl font-bold bg-linear-to-r from-teal-400 to-cyan-300 bg-clip-text text-transparent">PARKINGTICKET</span>
                            </div>
                            ...
                            <div className="flex items-center gap-2 sm:gap-4">
                                <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-secondary hover:bg-secondary/80 flex items-center justify-center transition-colors">
                        ...
                        <div className="col-span-1 md:col-span-3 grid grid-cols-3 gap-4 sm:gap-8">
                            <div>
                                <h4 className="text-foreground font-semibold text-xs sm:text-base mb-2 sm:mb-4">Product</h4>
                                <ul className="space-y-1 sm:space-y-3">
                                    <li><a href="#features" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Features</a></li>
                                    <li><a href="#pricing" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Pricing</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">API Docs</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Changelog</a></li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="text-foreground font-semibold text-xs sm:text-base mb-2 sm:mb-4">Company</h4>
                                <ul className="space-y-1 sm:space-y-3">
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">About Us</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Careers</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Blog</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Contact</a></li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="text-foreground font-semibold text-xs sm:text-base mb-2 sm:mb-4">Legal</h4>
                                <ul className="space-y-1 sm:space-y-3">
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Privacy</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Terms</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Cookies</a></li>
                                    <li><a href="#" className="text-muted-foreground hover:text-teal-500 text-[10px] sm:text-sm transition-colors">Security</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
