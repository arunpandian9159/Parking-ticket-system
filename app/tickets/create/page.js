                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-8">
                            ...
                            <div className="space-y-3 sm:space-y-5">
                                <div className="flex items-center gap-2 sm:gap-3 pb-2 border-b border-border">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] sm:text-xs text-muted-foreground hidden sm:block">Enter the customer's details</p>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-3 sm:space-y-5">
                                <div className="flex items-center gap-2 sm:gap-3 pb-2 border-b border-border">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-foreground text-sm sm:text-base">Vehicle Information</h3>
                                        <p className="text-[10px] sm:text-xs text-muted-foreground hidden sm:block">Enter the vehicle details</p>
                                    </div>
                                </div>
                                <div className="grid sm:grid-cols-2 gap-3 sm:gap-5">
                                    <div className="space-y-1.5 sm:space-y-2">
                            ...
                            <div className="space-y-3 sm:space-y-5">
                                <div className="flex items-center gap-2 sm:gap-3 pb-2 border-b border-border">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-foreground text-sm sm:text-base">Parking Details</h3>
                                        <p className="text-[10px] sm:text-xs text-muted-foreground hidden sm:block">Assign a parking spot and duration</p>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-2 sm:space-y-4">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="text-right">
                                        <div className={`text-xl sm:text-3xl font-bold ${passHolder ? 'text-teal-500' : 'text-foreground'}`}>
                                            ₹{formData.price}
                                        </div>
                                        {passHolder && (
                                            <div className="text-[10px] sm:text-xs text-teal-500">Pass holder discount</div>
                                        )}
                                    </div>
                                </div>
                            </div>
