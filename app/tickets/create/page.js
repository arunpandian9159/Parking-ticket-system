    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-foreground">Issue New Ticket</h1>
                    <p className="text-muted-foreground">Enter vehicle and parking details</p>
                </div>
            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-6">
                                    <h3 className="font-semibold text-foreground border-b border-border pb-2">Customer Details</h3>
                                    <Input
                                        label="Full Name"
                                        name="customer_name"
                                ...
                                <div className="space-y-6">
                                    <h3 className="font-semibold text-foreground border-b border-border pb-2">Parking Details</h3>
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium text-foreground">Parking Spot</label>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        />
                                        <div>
                                            <label className="text-sm font-medium text-foreground mb-1 block">Total Price</label>
                                            <div className={`
                                                h-10 px-3 flex items-center rounded-lg bg-secondary border border-border font-bold text-teal-500
                            ...
                            <div className="space-y-6">
                                <h3 className="font-semibold text-foreground border-b border-border pb-2">Vehicle Details</h3>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <Input
                                        label="License Plate"
                                        name="license_plate"
                                    ...
                                    />
                                    {passHolder && (
                                        <div className="text-sm text-teal-500 font-medium bg-teal-500/10 p-2 rounded-lg border border-teal-500/20 flex items-center gap-2">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full h-10 px-3 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-teal-500 bg-card text-foreground"
                                        >
                ...
                <div className={`md:block ${showMap ? 'block' : 'hidden'} order-first md:order-last`}>
                    <Card className="p-4 sticky top-6">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="font-semibold text-foreground">Select Spot</h3>
                            <button onClick={() => setShowMap(false)} className="md:hidden text-muted-foreground hover:text-foreground">Close</button>
                        </div>
                        <ParkingMap
