...
export default function TicketReceipt({ ticket }) {
  ...
  const qrUrl = getTicketQRUrl(ticket.id)

  return (
    <div
      id="ticket-receipt"
      className="hidden print:block print:w-full p-8 max-w-sm mx-auto bg-white"
    >
      ...
      <div className="mt-6 pt-4 border-t-2 border-dashed border-gray-300">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-[10px] text-gray-500 text-center">Scan to check status</p>
        </div>
      </div>
